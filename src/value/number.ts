...
export type MockNumberValue<State extends prismic.FieldState = prismic.FieldState> =
...
>(
	...
	return (config.state === "empty" ? null : faker.range(1, 100)) as MockNumberValue<State>
}
